...
<script type="text/javascript">
	...
	var process_bar_status=0;
	// 更改进度条
	function setProcessBarStatus(idIn,percentIn)
	{
	    document.getElementById(idIn).style.width=percentIn+"%";
	}
...
{
	// 创建点坐标  
	console.log("center at "+loc_x+","+loc_y);
...
<script type="text/javascript">
	// 百度地图API功能
	var map = new BMap.Map("map_main");    // 创建Map实例
